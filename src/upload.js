    ...
    <div>
      ...
      <Jumbotron>
        <Form noValidate onSubmit={handleUpload}>
          <Form.Group>
            <Form.Label>Selecione a imahem(PNG ouJPEG)</Form.Label>
            <Form.Control type="file" accept='image/png, image/jpeg' onChange={handleImagem}/>            
          </Form.Group>
          <Form.Group className='text-center'>
            <Button variant='success' type='submit' disabled={desabilitarBotao}>
      ...
      <Modal show={exibirModal} onHide={handleFecharModal}>
        ...
        <Modal.Footer>
          <Button variant='warning' onClick={handleFecharModal}>Fechar</Button>
        </Modal.Footer>
      </Modal>
    </div>
  );
